...
parser.add_argument('--vocab-size', type = int, default = 17308, choices = [17308, 8705, 5511, 5093, 4308, 4143])
...
parser.add_argument('--previous-restore-dir', default = 'combined_data-2019-01-14-17-09-36')
parser.add_argument('--previous-meta-file-path', default = 'combined_data-149900.meta')
...
from models import fc_progressive_nets as model
import numpy as np
import ray
