...
class Model:
    ...
    def _train(self):
        with tf.variable_scope('train'):
            ...
            # self.loss = tf.reduce_mean(name = 'loss',
            #                            input_tensor = self.cross_entropy) + self.args.reg_constant * self.regularization_loss
    ...
    def _init_word_embedding(self):
        ...
        :return:
        """
        # TODO: Integrate off the shelf embeddings like glove, ELMo, ULMFit
        # TODO: maybe define a different embedding for words and aspects
        # TODO: shouldn't padding have zero embedding? Is is possible to make just one row of embeddings
        ...
        with tf.variable_scope("embedding"):
            ...
            # TODO: implement fuse_aspect_words method
